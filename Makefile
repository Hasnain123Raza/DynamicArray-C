...
driver: src/driver.c src/DynamicArray.c
	mkdir bin
	gcc src/driver.c src/DynamicArray.c -Iincludes -o bin/driver

build: src/DynamicArray.c
	mkdir build
	gcc -c src/DynamicArray.c -Iincludes -o build/DynamicArray.o
	ar rcs build/libDynamicArray.a build/DynamicArray.o
	rm build/DynamicArray.o
	gcc -fPIC -c src/DynamicArray.c -Iincludes -o build/DynamicArray.o
